...
let GenerarPagoUseCase = class GenerarPagoUseCase {
    pagoBalanceRepository;
    configRepo;
    constructor(pagoBalanceRepository, configRepo) {
        this.pagoBalanceRepository = pagoBalanceRepository;
...
GenerarPagoUseCase = __decorate([
    Injectable(),
    __param(0, Inject(PAGO_BALANCE_REPOSITORY)),
    __param(1, Inject(CONFIGURACION_REPOSITORY)),
    __metadata("design:paramtypes", [Object, Object])
], GenerarPagoUseCase);
export { GenerarPagoUseCase };
//# sourceMappingURL=generar-pago.use-case.js.map