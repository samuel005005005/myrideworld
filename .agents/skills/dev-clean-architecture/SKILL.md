...
[`.agents/rules/desarrollo-convenciones-desarrollo.md`](../../rules/desarrollo-convenciones-desarrollo.md)
...
- **Una clase/interfaz pública por archivo** (ver `.agents/rules/desarrollo-una-clase-por-archivo.md`).
...
No redefinir el diagrama aquí: usar [`.agents/rules/desarrollo-convenciones-desarrollo.md`](../../rules/desarrollo-convenciones-desarrollo.md).  
